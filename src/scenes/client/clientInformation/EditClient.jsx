...
const EditClient = () => {
  ...
  return (
    <Box m="20px" height="80vh" overflow="auto" paddingRight="20px">
      <Header title={`EDIT CLIENT ID ${id}`} subtitle="Edit Client Details" />
      ...
      >
        {({
          ...
          <form onSubmit={handleSubmit}>
            ...
            >
              <Typography variant="h6">Name of the Client </Typography>
              <TextField
                fullWidth
                variant="filled"
                onBlur={handleBlur}
              ...
              />
              <Typography variant="h6">Client Description </Typography>
              <TextField
                fullWidth
                multiline
                variant="filled"
